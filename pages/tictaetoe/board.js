...
import styles from "../../styles/tictaetoe/board.module.css";
...
const Board = ({ reset, setReset, winner, setWinner }) => {
	...
	useEffect(() => {
        ...
        // for (let i = 0; i < 9; i++) {
        //     if (cells[i] !== null) { // Add a null check to avoid accessing undefined elements
        //       cells[i].innerText = '';
        //     }
        //   }
	...
	return (
		<div ref={boardRef} className={styles.board}>
			<div className={`${styles.input} ${styles['input-1']}`}
				onClick={(e) => draw(e, 1)}></div>
			<div className={`${styles.input} ${styles['input-2']}`}
				onClick={(e) => draw(e, 2)}></div>
			<div className={`${styles.input} ${styles['input-3']}`}
				onClick={(e) => draw(e, 3)}></div>
			<div className={`${styles.input} ${styles['input-4']}`}
				onClick={(e) => draw(e, 4)}></div>
			<div className={`${styles.input} ${styles['input-5']}`}
				onClick={(e) => draw(e, 5)}></div>
			<div className={`${styles.input} ${styles['input-6']}`}
				onClick={(e) => draw(e, 6)}></div>
			<div className={`${styles.input} ${styles['input-7']}`}
				onClick={(e) => draw(e, 7)}></div>
			<div className={`${styles.input} ${styles['input-8']}`}
				onClick={(e) => draw(e, 8)}></div>
			<div className={`${styles.input} ${styles['input-9']}`}
